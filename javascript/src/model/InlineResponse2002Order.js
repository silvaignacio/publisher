...
/**
 * The InlineResponse2002Order model module.
 * @module model/InlineResponse2002Order
 * @version 1.0
 */
class InlineResponse2002Order {
    /**
     * Constructs a new <code>InlineResponse2002Order</code>.
     * @alias module:model/InlineResponse2002Order
     */
    constructor() { 
        
        InlineResponse2002Order.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse2002Order</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2002Order} obj Optional instance to populate.
     * @return {module:model/InlineResponse2002Order} The populated <code>InlineResponse2002Order</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2002Order();
            ...
            if (data.hasOwnProperty('shipping_options')) {
                obj['shipping_options'] = InlineResponse2002OrderShippingOptions.constructFromObject(data['shipping_options']);
            }
 ...
 */
InlineResponse2002Order.prototype['currency'] = undefined;

/**
 * @member {Array.<Object>} discounts
 */
InlineResponse2002Order.prototype['discounts'] = undefined;

/**
 * @member {String} display_items_total_amount
 */
InlineResponse2002Order.prototype['display_items_total_amount'] = undefined;

/**
 * @member {String} display_shipping_amount
 */
InlineResponse2002Order.prototype['display_shipping_amount'] = undefined;

/**
 * @member {String} display_sub_total
 */
InlineResponse2002Order.prototype['display_sub_total'] = undefined;

/**
 * @member {String} display_tax_amount
 */
InlineResponse2002Order.prototype['display_tax_amount'] = undefined;

/**
 * @member {String} display_total_amount
 */
InlineResponse2002Order.prototype['display_total_amount'] = undefined;

/**
 * @member {Array.<Object>} items
 */
InlineResponse2002Order.prototype['items'] = undefined;

/**
 * @member {Number} items_total_amount
 */
InlineResponse2002Order.prototype['items_total_amount'] = undefined;

/**
 * @member {Object} metadata
 */
InlineResponse2002Order.prototype['metadata'] = undefined;

/**
 * @member {String} order_id
 */
InlineResponse2002Order.prototype['order_id'] = undefined;

/**
 * @member {Object} payment
 */
InlineResponse2002Order.prototype['payment'] = undefined;

/**
 * @member {module:model/InlineResponse2002OrderShippingAddress} shipping_address
 */
InlineResponse2002Order.prototype['shipping_address'] = undefined;

/**
 * @member {Number} shipping_amount
 */
InlineResponse2002Order.prototype['shipping_amount'] = undefined;

/**
 * @member {module:model/InlineResponse2002OrderShippingOptions} shipping_options
 */
InlineResponse2002Order.prototype['shipping_options'] = undefined;

/**
 * @member {String} status
 */
InlineResponse2002Order.prototype['status'] = undefined;

/**
 * @member {String} store_code
 */
InlineResponse2002Order.prototype['store_code'] = undefined;

/**
 * @member {Number} sub_total
 */
InlineResponse2002Order.prototype['sub_total'] = undefined;

/**
 * @member {Number} tax_amount
 */
InlineResponse2002Order.prototype['tax_amount'] = undefined;

/**
 * @member {Number} total_amount
 */
InlineResponse2002Order.prototype['total_amount'] = undefined;

/**
 * @member {String} user_instructions
 */
InlineResponse2002Order.prototype['user_instructions'] = undefined;
...
export default InlineResponse2002Order;
