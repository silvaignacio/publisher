...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.InlineResponse200Order();
  });
  ...
  describe('InlineResponse200Order', function() {
    it('should create an instance of InlineResponse200Order', function() {
      // uncomment below and update the code to test InlineResponse200Order
      //var instance = new ApiGateway.InlineResponse200Order();
      //expect(instance).to.be.a(ApiGateway.InlineResponse200Order);
    });
