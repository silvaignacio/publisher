...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsOrdersOrderShippingAddress();
  });
  ...
  describe('MerchantsOrdersOrderShippingAddress', function() {
    it('should create an instance of MerchantsOrdersOrderShippingAddress', function() {
      // uncomment below and update the code to test MerchantsOrdersOrderShippingAddress
      //var instance = new ApiGateway.MerchantsOrdersOrderShippingAddress();
      //expect(instance).to.be.a(ApiGateway.MerchantsOrdersOrderShippingAddress);
    });
