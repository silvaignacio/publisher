...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.InlineResponse200OrderShippingAddress();
  });
  ...
  describe('InlineResponse200OrderShippingAddress', function() {
    it('should create an instance of InlineResponse200OrderShippingAddress', function() {
      // uncomment below and update the code to test InlineResponse200OrderShippingAddress
      //var instance = new ApiGateway.InlineResponse200OrderShippingAddress();
      //expect(instance).to.be.a(ApiGateway.InlineResponse200OrderShippingAddress);
    });
